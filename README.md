...
- __VendingMachine(Feature)TestCase.rb:__ Six test cases are included as part of the test suite. Each test case corresponds to a feature and has the name of the feature embedded in the file name.
